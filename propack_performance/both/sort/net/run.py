...
def run_lam(nj, parallel):
    ...
    filename='response_net_'+str(nj)+'_'+n_num+'.txt'  ##
    ...
    while i < len(l):
        ...
        i+=1
    scale_time=start_list[int(len(start_list))-1]-start_time ## 
    service_time=end_list[int(len(end_list))-1]-start_time  ##
...
opt_list=[15,15,15,15,12,12,12,12,12,5,2] ##
